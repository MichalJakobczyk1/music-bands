...
buttonRightTprGoingToHell.addEventListener("click", () => {
    if (buttonTprGoingToHell.classList.contains("container__button--going-to-hell")) {
      changeContent(titleTpr,"Follow Me Down",buttonTprGoingToHell,"container__button--going-to-hell","container__button--follow-me-down");
      ...
      changeContent(titleTpr,"Absolution",buttonTprGoingToHell,"container__button--follow-me-down","container__button--absolution");
      ...
      changeContent(titleTpr,"Dear Sister",buttonTprGoingToHell,"container__button--absolution","container__button--dear-sister");
      ...
      changeContent(titleTpr,"Fucked Up World",buttonTprGoingToHell,"container__button--dear-sister","container__button--fucked-up-world");
      ...
      changeContent(titleTpr,"Heaven Knows",buttonTprGoingToHell,"container__button--fucked-up-world","container__button--heaven-knows");
      ...
      changeContent(titleTpr,"House On A Hill",buttonTprGoingToHell,"container__button--heaven-knows","container__button--house-on-a-hill");
      ...
      changeContent(titleTpr,"Sweet Things",buttonTprGoingToHell,"container__button--house-on-a-hill","container__button--sweet-things");
      ...
      changeContent(titleTpr,"Waiting For A Friend",buttonTprGoingToHell,"container__button--sweet-things","container__button--waiting-for-a-friend");
      ...
      changeContent(titleTpr,"Why'd You Bring A Shotgun To The Party",buttonTprGoingToHell,"container__button--waiting-for-a-friend","container__button--whyd-you-bring-a-shotgun-to-the-party");
      ...
      changeContent(titleTpr,"Going To Hell",buttonTprGoingToHell,"container__button--whyd-you-bring-a-shotgun-to-the-party","container__button--going-to-hell");
  ...
  buttonLeftTprGoingToHell.addEventListener("click", () => {
    if (buttonTprGoingToHell.classList.contains("container__button--going-to-hell")) {
      changeContent(titleTpr,"Why'd You Bring A Shotgun To The Party",buttonTprGoingToHell,"container__button--going-to-hell","container__button--whyd-you-bring-a-shotgun-to-the-party");
      pause(audioTprGoingToHell,buttonTprGoingToHell);
    } 
    else if (buttonTprGoingToHell.classList.contains("container__button--follow-me-down")) {
      changeContent(titleTpr,"Going To Hell",buttonTprGoingToHell,"container__button--follow-me-down","container__button--going-to-hell");
      pause(audioTprFollowMeDown,buttonTprGoingToHell);
    }
    else if (buttonTprGoingToHell.classList.contains("container__button--absolution")) {
      changeContent(titleTpr,"Follow Me Down",buttonTprGoingToHell,"container__button--absolution","container__button--follow-me-down");
      pause(audioTprAbsolution,buttonTprGoingToHell);
    }
    else if (buttonTprGoingToHell.classList.contains("container__button--dear-sister")) {
      changeContent(titleTpr,"Absolution",buttonTprGoingToHell,"container__button--dear-sister","container__button--absolution");
      pause(audioTprDearSister,buttonTprGoingToHell);
    }
    else if (buttonTprGoingToHell.classList.contains("container__button--fucked-up-world")) {
      changeContent(titleTpr,"Dear Sister",buttonTprGoingToHell,"container__button--fucked-up-world","container__button--dear-sister");
      pause(audioTprFuckedUpWorld,buttonTprGoingToHell);
    }
    else if (buttonTprGoingToHell.classList.contains("container__button--heaven-knows")) {
      changeContent(titleTpr,"Fucked Up World",buttonTprGoingToHell,"container__button--heaven-knows","container__button--fucked-up-world");
      pause(audioTprHeavenKnows,buttonTprGoingToHell);
    }
    else if (buttonTprGoingToHell.classList.contains("container__button--house-on-a-hill")) {
      changeContent(titleTpr,"Heaven Knows",buttonTprGoingToHell,"container__button--house-on-a-hill","container__button--heaven-knows");
      pause(audioTprHouseOnAHill,buttonTprGoingToHell);
    }
    else if (buttonTprGoingToHell.classList.contains("container__button--sweet-things")) {
      changeContent(titleTpr,"House On A Hill",buttonTprGoingToHell,"container__button--sweet-things","container__button--house-on-a-hill");
      pause(audioTprSweetThings,buttonTprGoingToHell);
    }
    else if (buttonTprGoingToHell.classList.contains("container__button--waiting-for-a-friend")) {
      changeContent(titleTpr,"Sweet Things",buttonTprGoingToHell,"container__button--waiting-for-a-friend","container__button--sweet-things");
      pause(audioTprWaitingForAFriend,buttonTprGoingToHell);
    }
    else if (buttonTprGoingToHell.classList.contains("container__button--whyd-you-bring-a-shotgun-to-the-party")) {
      changeContent(titleTpr,"Waiting For A Friend",buttonTprGoingToHell,"container__button--whyd-you-bring-a-shotgun-to-the-party","container__button--waiting-for-a-friend");
      pause(audioTprWhydYouBringAShotgunToTheParty,buttonTprGoingToHell);
    };
  });
